    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          ...
          <div className="bg-secondary-foreground/60 absolute top-[10rem] -z-10 left-[-35rem] h-[20.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-secondary-foreground/60"></div>
